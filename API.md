...
| <code><a href="#terraform-backend-s3-bucket.TerraformStateBackend.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="terraform-backend-s3-bucket.TerraformStateBackend.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="terraform-backend-s3-bucket.TerraformStateBackend.with.parameter.mixins"></a>
